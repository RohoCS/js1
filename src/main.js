 ...
 * #2
 *
 * Відформатуйте ціле число, яке зберігається у змінній myNum,
 ...
 * #3
 *
 * Створіть змінну i, для якої виконайте префіксний
 * та постфіксний інкремент і декремент.
 ...
 * #7
 *
 * Перевірте наявність тексту 'рама' у полі str об'єкта strObj (див.п.6),
 * результат збережіть у змінній isRamaPos та виведіть її у консоль.
